...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    ...
    <body >
        ...
        <div id="invoice"> 
            ...
            <div> 
                <?php if (isset($surat)) echo $surat; ?>
            </div> 
        </div> 
    </body>
</html>

<!--<div style="font-family: undefined;">&nbsp;Cor/Pulmo tidak tampak kelainan.</div>
<div style="font-family: undefined;">&nbsp; Tak tampak proses infeksi.</div>-->
