...
//        $result2 = implode('.', $titik_dua);
    ...
    public function add_cabang() {
        $input = $this->input->post(NULL, TRUE);
        if ($input['id'] != '') {
            $this->db->update('ms_cabang', $input, array('id' => $input['id']));
            echo json_encode(array('success' => 'true', 'data' => 'Test', 'title' => 'Info', 'msg' => 'Update Success'));
        } else {
            $this->db->insert('ms_cabang', $input);
            echo json_encode(array('success' => 'true', 'data' => NULL, 'title' => 'Info', 'msg' => 'Insert Success'));
        }
    }

    public function del_cabang() {
        $input = $this->input->post(NULL, TRUE);
        $this->db->delete('ms_cabang', array('id' => $input['id']));
        echo json_encode(array('success' => 'true', 'data' => NULL, 'title' => 'Info', 'msg' => 'Hapus Berhasil'));
    }

    //==================================================================
    // DIVISI
    //==================================================================
    public function list_msdivisi() {
        $records = $this->input->get('filter');
        $params = array();
    ...
    public function add_msdivisi() {
        $input = $this->input->post(NULL, TRUE);
        if ($input['id'] != '') {
            $this->db->update('ms_divisi', $input, array('id' => $input['id']));
            echo json_encode(array('success' => 'true', 'data' => 'Test', 'title' => 'Info', 'msg' => 'Update Success'));
        } else {
            $this->db->insert('ms_divisi', $input);
            echo json_encode(array('success' => 'true', 'data' => NULL, 'title' => 'Info', 'msg' => 'Insert Success'));
        }
    }

    public function del_msdivisi() {
        $input = $this->input->post(NULL, TRUE);
        $this->db->delete('ms_divisi', array('id' => $input['id']));
        echo json_encode(array('success' => 'true', 'data' => NULL, 'title' => 'Info', 'msg' => 'Hapus Berhasil'));
    }
    ...
    public function add_msposisi() {
        $input = $this->input->post(NULL, TRUE);
        if ($input['id'] != '') {
            $this->db->update('ms_posisi', $input, array('id' => $input['id']));
            echo json_encode(array('success' => 'true', 'data' => 'Test', 'title' => 'Info', 'msg' => 'Update Success'));
        } else {
            $this->db->insert('ms_posisi', $input);
            echo json_encode(array('success' => 'true', 'data' => NULL, 'title' => 'Info', 'msg' => 'Insert Success'));
        }
    }

    public function del_msposisi() {
        $input = $this->input->post(NULL, TRUE);
        $this->db->delete('ms_posisi', array('id' => $input['id']));
        echo json_encode(array('success' => 'true', 'data' => NULL, 'title' => 'Info', 'msg' => 'Hapus Berhasil'));
    }
    ...
    public function list_msjabatan() {
        $records = $this->input->get('filter');
        $params = array();

        $tablename = 'ms_jabatan';
        $opt['sortBy'] = 'id';
        $opt['sortDirection'] = 'ASC';
    ...
    public function add_msjabatan() {
        $input = $this->input->post(NULL, TRUE);
        if ($input['id'] != '') {
            $this->db->update('ms_jabatan', $input, array('id' => $input['id']));
            echo json_encode(array('success' => 'true', 'data' => 'Test', 'title' => 'Info', 'msg' => 'Update Success'));
        } else {
            $this->db->insert('ms_jabatan', $input);
            echo json_encode(array('success' => 'true', 'data' => NULL, 'title' => 'Info', 'msg' => 'Insert Success'));
        }
    }

    public function del_msjabatan() {
        $input = $this->input->post(NULL, TRUE);
        $this->db->delete('ms_jabatan', array('id' => $input['id']));
        echo json_encode(array('success' => 'true', 'data' => NULL, 'title' => 'Info', 'msg' => 'Hapus Berhasil'));
    }
    ...
    public function add_msstatus() {
        $input = $this->input->post(NULL, TRUE);
        if ($input['id'] != '') {
            $this->db->update('ms_status', $input, array('id' => $input['id']));
            echo json_encode(array('success' => 'true', 'data' => 'Test', 'title' => 'Info', 'msg' => 'Update Success'));
        } else {
            $this->db->insert('ms_status', $input);
            echo json_encode(array('success' => 'true', 'data' => NULL, 'title' => 'Info', 'msg' => 'Insert Success'));
        }
    }

    public function del_msstatus() {
        $input = $this->input->post(NULL, TRUE);
        $this->db->delete('ms_status', array('id' => $input['id']));
        echo json_encode(array('success' => 'true', 'data' => NULL, 'title' => 'Info', 'msg' => 'Hapus Berhasil'));
    }
    ...
    public function add_mssurat() {
        $input = $this->input->post(NULL, TRUE);
        if ($input['ms_id'] != '') {
            $this->db->update('ms_surat', $input, array('ms_id' => $input['ms_id']));
            echo json_encode(array('success' => 'true', 'data' => 'Test', 'title' => 'Info', 'msg' => 'Update Success'));
        } else {
            $this->db->insert('ms_surat', $input);
            echo json_encode(array('success' => 'true', 'data' => NULL, 'title' => 'Info', 'msg' => 'Insert Success'));
        }
    }
    ...
    public function list_mspegawai() {
        $records = $this->input->get('filter');
        $params = array();
    ...
    public function list_cabang_baru() {
        $records = $this->input->get('filter');
//        $query = $this->input->get('query');
        $params = array();
...
//        }
    ...
    public function list_jabatan_baru() {
        $records = $this->input->get('filter');
        $params = array();
    ...
    public function list_divisi_baru() {
        $records = $this->input->get('filter');
        $params = array();
    ...
    public function list_status_baru() {
        $records = $this->input->get('filter');
        $params = array();
    ...
    public function list_pekerjaan_baru() {
        $records = $this->input->get('filter');
        $params = array();

        $tablename = 'ms_pekerjaan';
        $opt['sortBy'] = 'id';
        $opt['sortDirection'] = 'ASC';
    ...
    public function list_posisi_baru() {
        $records = $this->input->get('filter');
        $params = array();
    ...
    public function list_ruang() {
        ...
        $result = $this->Ivmsbarang_model->gets($params, NULL, 'ms_status');
        $list = array();
...
//        }
    ...
    public function preview($id) {
        $surat = $this->db->where(array('ms_id' => $id))->from('ms_surat')->get()->row();
        $data['test'] = $surat->ms_template;
    ...
    public function spreview($id) {
        $surat = $this->query->get_detail('t_surat', 'surat_id', $id);
//        $this->db->where(array('surat_id' => $id))->from('t_surat')->get()->row();
        $data['surat'] = $this->surat->get_surat($id);
//        $data['test'] = $surat->ms_template;
        $this->load->view('preview', $data);
    }
