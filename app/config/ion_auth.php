...
*/
$config['tables']['users']           = 'ms_karyawan';
 ...
 */
$config['site_title']                 = "LAB Parahita";       // Site Title, example.com
$config['admin_email']                = "edp@labparahita.com"; // Admin Email, admin@example.com
