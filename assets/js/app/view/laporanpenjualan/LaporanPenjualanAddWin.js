 ...
 * IT Parahita@2015
 **/
Ext.define('SIForLaP.view.laporanpenjualan.LaporanPenjualanAddWin', {
    extend: 'Ext.window.Window',
    alias: 'widget.laporanpenjualan.laporanpenjualanaddwin',
    itemId: 'pendaftaranlaporanpenjualanaddwin',
    ui: 'blue-window',
    ...
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            items: [
                {
                    xtype: 'form',
                    itemId: 'FormLaporanPenjualanAddWin',
                    bodyPadding: 10,
                    fieldDefaults: {
                        width: 300,
                        labelAlign: 'right',
            ...
            buttons: [
                {
                    ...
                    listeners: {
                        click: function () {
                            var form = me.down('#FormLaporanPenjualanAddWin').getForm();
                            Ext.Ajax.request({
                                ...
                                callback: function (options, success, response) {
                                    ...
                                    if (resp.success === 'true') {
                                        ...
                                        me.close();
                                        var grid = Ext.ComponentQuery.query('panel > #laporanpenjualangrid')[0];
                                        grid.getStore().load();
                                    } else {
                                        Ext.MessageBox.show({
                                            title: resp.title,
