 ...
 * IT Parahita@2015
 **/
Ext.define('SIForLaP.view.penerimaankas.PenerimaanKasAddWin', {
    extend: 'Ext.window.Window',
    alias: 'widget.penerimaankas.penerimaankasaddwin',
    itemId: 'pendaftaranpenerimaankasaddwin',
    ui: 'blue-window',
    ...
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            items: [
                {
                    xtype: 'form',
                    itemId: 'FormPenerimaanKasAddWin',
                    bodyPadding: 10,
                    fieldDefaults: {
                        width: 300,
                        labelAlign: 'right',
            ...
            buttons: [
                {
                    ...
                    listeners: {
                        click: function () {
                            var form = me.down('#FormPenerimaanKasAddWin').getForm();
                            Ext.Ajax.request({
                                ...
                                callback: function (options, success, response) {
                                    ...
                                    if (resp.success === 'true') {
                                        ...
                                        me.close();
                                        var grid = Ext.ComponentQuery.query('panel > #penerimaankasgrid')[0];
                                        grid.getStore().load();
                                    } else {
                                        Ext.MessageBox.show({
                                            title: resp.title,
