 ...
 * IT Parahita@2015
 **/
Ext.define('SIForLaP.view.laporanhutang.LaporanHutangAddWin', {
    extend: 'Ext.window.Window',
    alias: 'widget.laporanhutang.laporanhutangaddwin',
    itemId: 'pendaftaranlaporanhutangaddwin',
    ui: 'blue-window',
    ...
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            items: [
                {
                    xtype: 'form',
                    itemId: 'FormLaporanHutangAddWin',
                    bodyPadding: 10,
                    fieldDefaults: {
                        width: 300,
                        labelAlign: 'right',
            ...
            buttons: [
                {
                    ...
                    listeners: {
                        click: function () {
                            var form = me.down('#FormLaporanHutangAddWin').getForm();
                            Ext.Ajax.request({
                                ...
                                callback: function (options, success, response) {
                                    ...
                                    if (resp.success === 'true') {
                                        ...
                                        me.close();
                                        var grid = Ext.ComponentQuery.query('panel > #laporanhutanggrid')[0];
                                        grid.getStore().load();
                                    } else {
                                        Ext.MessageBox.show({
                                            title: resp.title,
