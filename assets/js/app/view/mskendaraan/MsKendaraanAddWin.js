 ...
 * IT Parahita@2015
 **/
Ext.define('SIForLaP.view.mskendaraan.MsKendaraanAddWin', {
    extend: 'Ext.window.Window',
    alias: 'widget.mskendaraan.mskendaraanaddwin',
    itemId: 'pendaftaranmskendaraanaddwin',
    ui: 'blue-window',
            ...
            buttons: [
                {
                    ...
                    listeners: {
                        click: function () {
                            var form = me.down('#FormMsKendaraanAddWin').getForm();
                            Ext.Ajax.request({
                                ...
                                callback: function (options, success, response) {
                                    ...
                                    if (resp.success === 'true') {
                                        ...
                                        me.close();
                                        var grid = Ext.ComponentQuery.query('panel > #mskendaraangrid')[0];
                                        grid.getStore().load();
                                    } else {
                                        Ext.MessageBox.show({
                                            title: resp.title,
