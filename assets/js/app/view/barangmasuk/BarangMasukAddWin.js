 ...
 * IT Parahita@2015
 **/
Ext.define('SIForLaP.view.barangmasuk.BarangMasukAddWin', {
    extend: 'Ext.window.Window',
    alias: 'widget.barangmasuk.barangmasukaddwin',
    itemId: 'pendaftaranbarangmasukaddwin',
    ui: 'blue-window',
            ...
            buttons: [
                {
                    ...
                    listeners: {
                        click: function () {
                            var form = me.down('#FormBarangMasukAddWin').getForm();
                            Ext.Ajax.request({
                                ...
                                callback: function (options, success, response) {
                                    ...
                                    if (resp.success === 'true') {
                                        ...
                                        me.close();
                                        var grid = Ext.ComponentQuery.query('panel > #barangmasukgrid')[0];
                                        grid.getStore().load();
                                    } else {
                                        Ext.MessageBox.show({
                                            title: resp.title,
