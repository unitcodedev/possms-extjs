 ...
 * IT Parahita@2015
 **/
Ext.define('SIForLaP.view.msgudang.MsGudangAddWin', {
    extend: 'Ext.window.Window',
    alias: 'widget.msgudang.msgudangaddwin',
    itemId: 'pendaftaranmsgudangaddwin',
    ui: 'blue-window',
            ...
            buttons: [
                {
                    ...
                    listeners: {
                        click: function () {
                            var form = me.down('#FormMsGudangAddWin').getForm();
                            Ext.Ajax.request({
                                ...
                                callback: function (options, success, response) {
                                    ...
                                    if (resp.success === 'true') {
                                        ...
                                        me.close();
                                        var grid = Ext.ComponentQuery.query('panel > #msgudanggrid')[0];
                                        grid.getStore().load();
                                    } else {
                                        Ext.MessageBox.show({
                                            title: resp.title,
