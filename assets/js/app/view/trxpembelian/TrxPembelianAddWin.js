 ...
 * Marz@2017
 **/
Ext.define('SIForLaP.view.trxpembelian.TrxPembelianAddWin', {
    extend: 'Ext.window.Window',
    alias: 'widget.trxpembelian.trxpembelianaddwin',
    itemId: 'pendaftarantrxpembelianaddwin',
    ui: 'blue-window',
            ...
            buttons: [
                {
                    ...
                    listeners: {
                        click: function () {
                            var form = me.down('#FormTrxPembelianAddWin').getForm();
                            Ext.Ajax.request({
                                ...
                                callback: function (options, success, response) {
                                    ...
                                    if (resp.success === 'true') {
                                        ...
                                        me.close();
                                        var grid = Ext.ComponentQuery.query('panel > #trxpembeliangrid')[0];
                                        grid.getStore().load();
                                    } else {
                                        Ext.MessageBox.show({
                                            title: resp.title,
