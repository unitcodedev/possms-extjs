 ...
 * IT Parahita@2015
 **/
Ext.define('SIForLaP.view.fopendaftaran.FoPendaftaranForm', {
    extend: 'Ext.form.Panel',
    alias: 'widget.fopendaftaran.fopendaftaranform',
    itemId: 'fopendaftaranform',
    id: 'fopendaftaranform',
//    bodyStyle: FORM_BG,
    bodyPadding: '5 5',
    buttonAlign: 'right',
                                            ...
                                            listeners: {
                                                keyup: function (form, e) {
                                                    if (e.getKey() === 112 || e.getKey() === 13) {
                                                        var win = Ext.widget('fopendaftaran.listpasienwin');
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    queryMode: 'local',
                                    allowBlank: false,
                                    store: 'fopendaftaran.DaftarSdmStore',
...
//                                        me.down('#itemIdPendaftaranDiscountRp').hide();
                                        ...
                                        var jumlah = Ext.getCmp('fopendaftarangrid').getStore().getCount()
                                        var discount = 0;
                                        for (var i = 0; i < jumlah; i++) {
                                            Ext.getCmp('fopendaftarangrid').getStore().getAt(i).set('diskon_pemeriksaan', discount);
                                        }
...
//                                                var jumlah = Ext.getCmp('fopendaftarangrid').getStore().getCount()
//                                                for (var i = 0; i < jumlah; i++) {
//                                                    var record = Ext.getCmp('fopendaftarangrid').getStore().getAt(i);
                            ...
                            listeners: {
                                change: function (rb, nv, ov, options) {
                                    ...
                                    if (status_kirim === 3) {
                                        ...
                                        filterCollection.push(statusFilter);
                                        Ext.getCmp('fopendaftaranmasterbank').getStore().clearFilter(true)
                                        Ext.getCmp('fopendaftaranmasterbank').getStore().filter(filterCollection);
                                        Ext.getCmp('fopendaftaranmasterbank').setValue('');
...
//                            hidden: true,
                        ...
                        },
                        {
                            ...
                            triggerAction: 'all',
                            valueNotFoundText: 'Tidak ada Data',
                            store: 'fopendaftaran.JenisKartuBankStore',
                            listeners: {
                                select: function (cmb, rec, opt) {
                                    var form = me.getForm();
                                    var val = cmb.getValue(),
                        ...
                        },
                        {
                            ...
                            triggerAction: 'all',
                            valueNotFoundText: 'Tidak ada Data',
                            store: 'fopendaftaran.NomorEDCStore',
                        },
                        {
                            xtype: 'radiogroup',
                            hideLabel: true,
...
//                                            alert(e.getKey());
                                            if (e.getKey() === 112 || e.getKey() === 13) {
                                                var win = Ext.widget('fopendaftaran.listdokterpenagihanwin');
...
//
                        ...
                        },
                        {
                            ...
                            items: [{
                                    ...
                                    listeners: {
                                        keyup: function (form, e) {
                                            if (e.getKey() === 112 || e.getKey() === 13) {
                                                var win = Ext.widget('fopendaftaran.listrekananpenagihanwin');
            ...
            bbar: [
                ...
                },
                {
                    ...
                    iconCls: 'icon-btn-discount',
                    handler: function () {
                        var winapprove = Ext.widget('fopendaftaran.foapprovebelumbayarwin');
                    }
                },
                {
                    xtype: 'tbtext',
