 ...
 * IT Parahita@2015
 **/
Ext.define('SIForLaP.view.laporanpiutang.LaporanPiutangAddWin', {
    extend: 'Ext.window.Window',
    alias: 'widget.laporanpiutang.laporanpiutangaddwin',
    itemId: 'pendaftaranlaporanpiutangaddwin',
    ui: 'blue-window',
    ...
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            items: [
                {
                    xtype: 'form',
                    itemId: 'FormLaporanPiutangAddWin',
                    bodyPadding: 10,
                    fieldDefaults: {
                        width: 300,
                        labelAlign: 'right',
            ...
            buttons: [
                {
                    ...
                    listeners: {
                        click: function () {
                            var form = me.down('#FormLaporanPiutangAddWin').getForm();
                            Ext.Ajax.request({
                                ...
                                callback: function (options, success, response) {
                                    ...
                                    if (resp.success === 'true') {
                                        ...
                                        me.close();
                                        var grid = Ext.ComponentQuery.query('panel > #laporanpiutanggrid')[0];
                                        grid.getStore().load();
                                    } else {
                                        Ext.MessageBox.show({
                                            title: resp.title,
